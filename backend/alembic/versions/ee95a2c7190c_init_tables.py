...
Revision ID: ee95a2c7190c
Revises: 
Create Date: 2025-06-13 00:03:19.998002
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_devices_bluetooth_address'), 'devices', ['bluetooth_address'], unique=True)
    op.create_index(op.f('ix_devices_id'), 'devices', ['id'], unique=False)
    op.create_table('messages',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('is_delivered', sa.Integer(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_devices_bluetooth_address'), table_name='devices')
